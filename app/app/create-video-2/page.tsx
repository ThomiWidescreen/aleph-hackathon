 ...
 * Combina la funcionalidad del primer archivo con la estética del segundo archivo.
 */
export default function CreateVideoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createVideo({
        ...
        authorAddress: "0x0c892815f0B058E69987920A23FBb33c834289cf", // TODO: Replace with actual address
        videoData: file || "",
      });
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#090619] text-white">
      {/* Header */}
      <header className="sticky top-0 z-10 bg-[#090619] p-4 shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full p-2 border rounded-md bg-[#1E1E2A] text-white ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                min="0"
                step="0.01"
                className={`w-full p-2 pl-8 border rounded-md bg-[#1E1E2A] text-white ${
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border rounded-md bg-[#1E1E2A] text-white border-gray-700"
            />
          </div>
          ...
          <div>
            ...
            <div
              className={`mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-md ${
                isDragging ? "border-blue-400 bg-blue-50" : "border-gray-700"
